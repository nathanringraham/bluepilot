...
class PowerMonitoring:
  ...
  def should_shutdown(self, ignition: bool, in_car: bool, offroad_timestamp: float | None, started_seen: bool):
    ...
    # BluePilot: Custom shutdown voltage - vbatt_pause_charging param allows user-configurable cutoff
    try:
    ...
    # BluePilot: Custom shutdown voltage threshold using configurable param
